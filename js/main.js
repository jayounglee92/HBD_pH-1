(() => {
	...
	const sceneInfo = [
		...
		},
		{
			...
			objs: {
				...
				imagesPath: [
					'./images/section3-image-1.jpg',
					'./images/section3-image-2.jpg'
                ],
                imagesAlt: [
					'pH-1 미모티콘',
					'2020 pH-1 Concert Roommate search 엔딩 이미지'
				],
				images: []
			},
			values: {
	...
	function setCanvasImages() {
		...
		for (let i = 0; i < sceneInfo[0].values.videoImageCount; i++) {
			imgElem = new Image();
            imgElem.src = `./video/003/perfectmv(${1 + i}).jpg`;
            imgElem.alt = `pH-1 - Perfect 뮤직비디오 이미지${1 + i}`;
		...
		for (let i = 0; i < sceneInfo[3].objs.imagesPath.length; i++) {
            ...
            imgElem3.alt = sceneInfo[3].objs.imagesAlt[i];
	...
	function playAnimation() {
		...
		switch (currentScene) {
			case 0:
                ...
                objs.canvas.style.width = window.innerWidth;
				if (scrollRatio <= 0.22) {
					// in
